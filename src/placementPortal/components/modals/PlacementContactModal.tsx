...
import { X, Mail, Phone, MapPin, Send, CheckCircle, Clock, UserCheck } from 'lucide-react';
...
export const PlacementContactModal: React.FC<PlacementContactModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#082B5C]/80 backdrop-blur-md animate-in fade-in duration-300">
      <div 
        className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-200 animate-in zoom-in-95 duration-300 max-h-[92vh] overflow-y-auto"
      ...
      >
        ...
        <div className="p-6 sm:p-7 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="p-3 bg-[#F5FAFF] rounded-xl border border-blue-100 flex items-start gap-2.5">
              <Phone className="w-4 h-4 text-[#1769AA] shrink-0 mt-0.5" />
              <div>
                <p className="text-[10px] uppercase font-bold text-slate-500">Direct Desk</p>
                <p className="text-xs font-semibold text-[#082B5C]">044-2747 0021</p>
                <p className="text-[11px] text-slate-500">Ext: 114 / 115</p>
              </div>
            </div>
            <div className="p-3 bg-[#F5FAFF] rounded-xl border border-blue-100 flex items-start gap-2.5">
              <Mail className="w-4 h-4 text-[#1769AA] shrink-0 mt-0.5" />
              <div>
                <p className="text-[10px] uppercase font-bold text-slate-500">Official Email</p>
                <p className="text-xs font-semibold text-[#082B5C]">placement@msajce-edu.in</p>
                <p className="text-[11px] text-slate-500">Quick response desk</p>
              </div>
            </div>
            <div className="p-3 bg-[#F5FAFF] rounded-xl border border-blue-100 flex items-start gap-2.5">
              <MapPin className="w-4 h-4 text-[#1769AA] shrink-0 mt-0.5" />
              <div>
                <p className="text-[10px] uppercase font-bold text-slate-500">Office Suite</p>
                <p className="text-xs font-semibold text-[#082B5C]">Placement Suite</p>
                <p className="text-[11px] text-slate-500">Admin Block, 2nd Floor</p>
              </div>
            </div>
          </div>
          ...
          {submitted ? (
            <div className="p-6 bg-emerald-50 rounded-2xl border border-emerald-200 text-center space-y-3">
              ...
              <h4 className="text-base font-bold text-emerald-900">Inquiry Dispatched Successfully!</h4>
              ...
              <button
                ...
                className="mt-2 px-5 py-2 rounded-lg bg-[#082B5C] text-white text-xs font-semibold hover:bg-[#1769AA] transition-colors"
              >
                Done
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs sm:text-sm bg-slate-50 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1769AA] text-slate-800"
                  />
                </div>
                <div>
              ...
              <div>
                <label className="block text-xs font-semibold text-slate-700 mb-1">Detailed Message / Requirement *</label>
                <textarea
                  required
                  rows={3}
              ...
              <div className="pt-2 flex items-center justify-between">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 rounded-lg bg-[#082B5C] hover:bg-[#1769AA] text-white text-xs font-semibold tracking-wide flex items-center gap-2 transition-all shadow-md active:scale-98 cursor-pointer"
                >
