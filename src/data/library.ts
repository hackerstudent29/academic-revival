...
export const collectionStats: LibraryStat[] = [
  ...
  {
    label: "Database (Gale) International Journals",
    count: "1,800",
    numericValue: 1800,
    suffix: "+",
    category: "digital",
...
export const libraryServices: LibraryService[] = [
  ...
  },
  {
    ...
    title: "Periodical Utilization & Newspaper Gallery",
...
export const overdueFineSlabs = [
  {
    period: "After 30 Days: First 6 Days",
    slab: "Days 1 to 6",
    rate: "₹ 1.00",
  ...
  {
    period: "After 30 Days: 7 to 14 Days",
    slab: "Days 7 to 14",
    rate: "₹ 2.00",
    unit: "per day per book",
    severity: "medium",
...
export const libraryRules = [
  {
    id: 1,
    rule: "All the Staff and Students are the members of our College Library.",
  },
  {
    id: 2,
    rule: "All the students are eligible to borrow 18 Books.",
  },
  {
    id: 3,
    rule: "All staff are eligible to borrow Books.",
  },
  {
    id: 4,
    rule: "Reference books and periodicals will not be issued.",
  },
  {
    id: 5,
    rule: "Library ID is not transferable.",
  },
  {
    id: 6,
    rule: "Member should notify the Librarian any loss of cards and change of address immediately.",
  },
  {
    id: 7,
    rule: "The User may reserve a book in circulation. He will be notified as soon as the reserved books are returned. The book will be retained at the circulation Desk for a one-day from the date of return.",
  },
  {
    id: 8,
    rule: "Books will be issued for a short duration of 30 days only.",
  },
  {
    id: 9,
    rule: "After 30 days First 6 days Rs 1.00 per book per day.",
  },
  {
    id: 10,
    rule: "From 7 to 14 days Rs 2.00 per book per day.",
  },
  {
    id: 11,
    rule: "From 15 days onwards Rs 5.00 per book per day.",
  },
  {
    id: 12,
  ...
  {
    id: 13,
    rule: "Personal belongings (bags, briefcases, folders) must be deposited in the property racks at the library entrance.",
  },
  {
    id: 14,
...
export const institutionalMemberships = [
  {
    id: "delnet",
    name: "DELNET (Developing Library Network)",
    scope: "Inter-Library Loan Network",
    summary: "Inter-library loans and document delivery across 8,000+ institutions with access to 1,379+ indexed e-journals.",
    features: [
      "Inter-library loan & document delivery across 8,000+ institutions",
      "Access to Union Catalogue and 1,379+ electronic journals",
    ],
    website: "https://delnet.in/",
    badge: "Consortium Partner",
  },
  {
    id: "jgate",
    name: "J-Gate Plus Database",
    scope: "E-Journal Discovery Platform",
    summary: "Comprehensive scholarly indexing of 50,684+ peer-reviewed electronic journals across Engineering & Technology.",
    features: [
      "Unified discovery across 50,684+ peer-reviewed e-journals",
      "Direct full-text linking for Engineering, Tech & Applied Sciences",
    ],
...
export const libraryCommittee: CommitteeMember[] = [
  ...
  { sno: 5, name: "Dr. A. Kamalaselvan", designation: "Library In-Charge", role: "Secretary", type: "Faculty" },
  { sno: 6, name: "Mrs. P. Anusuya", designation: "AP / ECE & Library In-Charge", role: "Member Secretary", type: "Faculty", department: "ECE" },
  ...
  { sno: 10, name: "Mr. K. Arshad", designation: "III-Yr EEE Student Representative", role: "Member", type: "Student", department: "EEE" },
  { sno: 11, name: "Ms. S. Swetha Maria Saustina", designation: "III-Yr EEE Student Representative", role: "Member", type: "Student", department: "EEE" },
  { sno: 12, name: "Mr. B. Mohamed Nayeem", designation: "III-Yr ECE Student Representative", role: "Member", type: "Student", department: "ECE" },
  { sno: 13, name: "Ms. D. Kamali", designation: "III-Yr EEE Student Representative", role: "Member", type: "Student", department: "EEE" },
  { sno: 14, name: "Mr. N. Vasanthakumar", designation: "III-Yr MECH Student Representative", role: "Member", type: "Student", department: "Mechanical" },
  { sno: 15, name: "Mr. S. Salman", designation: "III-Yr MECH Student Representative", role: "Member", type: "Student", department: "Mechanical" },
  { sno: 16, name: "Mr. J. Musthaq", designation: "III-Yr CIVIL Student Representative", role: "Member", type: "Student", department: "Civil" },
  { sno: 17, name: "Mr. S. Shanmugam", designation: "III-Yr CIVIL Student Representative", role: "Member", type: "Student", department: "Civil" },
  { sno: 18, name: "Ms. U. Revathi", designation: "III-Yr IT Student Representative", role: "Member", type: "Student", department: "IT" },
  { sno: 19, name: "Mr. J. Imamm Jaffar", designation: "III-Yr IT Student Representative", role: "Member", type: "Student", department: "IT" },
  { sno: 20, name: "Mr. V. Elango", designation: "III-Yr CSE Student Representative", role: "Member", type: "Student", department: "CSE" },
  { sno: 21, name: "Ms. A. Vasumathi", designation: "III-Yr CSE Student Representative", role: "Member", type: "Student", department: "CSE" },
];
