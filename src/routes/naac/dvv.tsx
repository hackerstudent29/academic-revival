...
export const Route = createFileRoute("/naac/dvv")({
  component: DVVClarification,
});

function DVVClarification() {
  return (
        ...
        <div className="mx-auto max-w-[1440px] relative z-10">
          <Reveal>
            <div className="flex flex-col gap-3 max-w-3xl">
              ...
              <h1 className="text-4xl md:text-6xl font-black font-oswald uppercase text-white drop-shadow-md">DVV Clarification</h1>
            </div>
          </Reveal>
        </div>
      </section>
