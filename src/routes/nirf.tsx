        ...
        <div className="mx-auto max-w-[1440px] px-6 md:px-12 w-full">
          <Reveal>
            <div className="flex flex-col max-w-4xl">
              ...
              <h1 className="text-4xl md:text-6xl font-black font-oswald uppercase text-foreground">NIRF</h1>
      ...
      <section className="mx-auto max-w-[1440px] px-6 md:px-12 py-12 w-full flex-grow">
        <Reveal>
          <div className="space-y-12">
            <div>
              <h2 className="text-3xl font-black font-oswald uppercase text-foreground mb-6">NIRF Documents</h2>
              <p className="text-foreground/80 mb-8 font-sans">
                Browse our repository of NIRF ranking submissions and annual reports.
              </p>
              
              {nirfDocs && nirfDocs.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {nirfDocs.map((doc, idx) => (
                    <a 
                      key={idx} 
