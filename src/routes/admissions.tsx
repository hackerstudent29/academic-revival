...
function Admissions() {
  ...
  return (
    <main className="bg-background dark:bg-[#121214] min-h-screen pt-0 md:pt-1 text-foreground font-libre antialiased selection:bg-primary selection:text-white transition-colors">
      {/* ========================================================================= */}
      ...
      {/* ========================================================================= */}
      <section className="py-8 sm:py-10 md:py-12 bg-background dark:bg-[#121214] transition-colors">
      ...
      {/* ========================================================================= */}
      <div className="w-full overflow-hidden leading-none select-none bg-background dark:bg-[#121214]">
        <svg
          viewBox="0 0 1440 72"
          fill="none"
