...
function Admissions() {
  ...
  return (
    <main className="bg-background text-foreground min-h-screen pt-0 md:pt-1">
          ...
          <StaggerItem>
            <Link to="/admissions/procedure" className="group flex flex-col justify-between h-full border border-border bg-card p-8 hover:bg-muted/50 transition-colors">
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed font-sans">Step-by-step guidelines to apply online, verify documents, and confirm your seat.</p>
              </div>
              <div className="mt-8 flex items-center justify-between">
                <span className="text-xs font-bold uppercase tracking-wider text-primary font-oswald">View details</span>
                <ArrowRight className="h-5 w-5 text-primary transition-transform group-hover:translate-x-1" />
      ...
      <section id="programmes" className="bg-page-bg text-foreground border-t border-border">
