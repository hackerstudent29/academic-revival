...
function Admissions() {
  ...
  return (
    <main className="bg-page-bg text-foreground min-h-screen pt-4 md:pt-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-12">
            {hasUrlFilter ? (
              <div className="flex flex-wrap gap-3">
                ...
                <Link to="/programmes" search={{ level: undefined }} className="px-4 py-2 border border-border text-muted-foreground hover:border-foreground text-sm flex items-center gap-2 transition-colors">
