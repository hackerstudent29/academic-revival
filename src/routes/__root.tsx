...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "MSAJCE — M.S.A.J. College of Engineering, Chennai" },
      {
        name: "description",
        content:
          "MSAJCE is an engineering campus on Chennai's OMR IT corridor offering UG, PG and research programmes.",
      },
      { name: "author", content: "MSAJCE" },
      { property: "og:title", content: "MSAJCE — M.S.A.J. College of Engineering" },
      {
        property: "og:description",
        content: "UG, PG and research engineering programmes on Chennai's OMR IT corridor.",
      },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      ...
      <div className="bg-background text-foreground">
          <div 
            className="relative z-10 isolate flex min-h-screen flex-col shadow-2xl"
