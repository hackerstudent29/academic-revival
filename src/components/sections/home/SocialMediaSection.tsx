...
export function SocialMediaSection() {
  return (
    <section 
      id="social-media" 
      className="relative z-10 w-full bg-[#EAEFF5] dark:bg-[#121214] py-16 md:py-24 overflow-hidden section-content-visibility"
    >
      <div className="mx-auto w-full max-w-[1440px] px-6 md:px-12 lg:px-16 flex flex-col items-center">
        ...
        >
          ...
          <div className="flex justify-center mb-8">
            <Link
              to="/social-media"
              className="group relative overflow-hidden inline-flex items-center justify-center border border-stone-300 dark:border-neutral-700 bg-stone-200/90 dark:bg-neutral-800 px-7 py-3 text-xs font-bold uppercase tracking-widest text-foreground dark:text-white font-oswald shadow-xs transition-colors rounded-tl-xl rounded-br-xl rounded-tr-xs rounded-bl-xs"
            >
              ...
              <span className="relative z-10 flex items-center gap-2 text-foreground dark:text-white group-hover:text-white transition-colors duration-300">
