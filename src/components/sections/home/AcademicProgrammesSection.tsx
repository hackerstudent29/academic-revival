              ...
              >
                ...
                <div className="p-5 pt-3 z-30 bg-[#F3F3F2] dark:bg-[#121214] border-t border-border">
                  <Link
                    ...
                    className="group relative overflow-hidden inline-flex items-center justify-center border border-stone-300 dark:border-neutral-700 bg-stone-200/90 dark:bg-neutral-800 px-5 py-3 text-xs font-bold uppercase tracking-wider text-foreground dark:text-white font-oswald shadow-xs transition-colors rounded-tl-xl rounded-br-xl rounded-tr-xs rounded-bl-xs w-full text-center"
                  >
                    ...
                    <span className="relative z-10 flex items-center justify-center gap-1.5 text-foreground dark:text-white group-hover:text-white transition-colors duration-300">
                      {lvl.cta} &raquo;
                    </span>
                  </Link>
                </div>
