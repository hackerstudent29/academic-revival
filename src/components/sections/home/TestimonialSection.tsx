...
export function TestimonialSection() {
  ...
  return (
    <section className="relative z-10 w-full bg-[#EAEAEA] dark:bg-[#121214] pt-16 pb-24 md:pt-20 md:pb-32 overflow-hidden scroll-mt-24 section-content-visibility" id="alumni">
